...
public static class Input
{
    ...
    {
        return WindowsDriver.IsKeyPressed((int)key);
    }
}
...
public enum Key
{
    ...
    // 0xE0,                   // Reserved
    // 0xE1,                   // OEM specific
    VK_OEM_102 = 0xE2, // The <> or \| key on the RT 102-key keyboard
    ...
    // 0xE6,                   // OEM specific
    VK_PACKET =
        0xE7, // Used to pass Unicode characters as if they were keystrokes. The VK_PACKET key is the low word of a 32-bit Virtual Key value used for non-keyboard input methods.
